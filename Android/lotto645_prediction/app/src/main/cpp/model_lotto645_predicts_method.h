...
#define LAST_GAME   "1 ~ 1143회\n(2024.10.26 추첨까지)"
const char* last_game = "no.1143"; // range: no.1 ~ present
int result_won[] = { 10, 16, 17, 27, 28, 36, 6 };
...
float digits_mid_code[5][3] = {
    ...
    { 1, 1583, 1.384951881014873f, },
    { 10, 1838, 1.6080489938757656f, },
    { 20, 1709, 1.495188101487314f, },
    { 30, 1811, 1.584426946631671f, },
    { 40, 1060, 0.9273840769903762f, },
};
...
float odd_even_code[45][9] = {
    ...
    { 6, 90.0f, 46.0f, 13.0f, 3.0f, 0.0f, 0.0f, 32.0f, 184.0f, },
