...
#define LAST_GAME   "1 ~ 1142회\n(2024.10.19 추첨까지)"
const char* last_game = "no.1142"; // range: no.1 ~ present
int result_won[] = { 2, 8, 28, 30, 37, 41, 22 };
...
float digits_mid_code[5][3] = {
    ...
    { 1, 1582, 1.3852889667250439f, },
    { 10, 1835, 1.606830122591944f, },
    { 20, 1707, 1.4947460595446584f, },
    { 30, 1810, 1.584938704028021f, },
    { 40, 1060, 0.9281961471103327f, },
};
...
float odd_even_code[45][9] = {
    ...
    { 28, 0.0f, 4.0f, 39.0f, 41.0f, 45.0f, 12.0f, 22.0f, 163.0f, },
