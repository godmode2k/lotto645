...
#define LAST_GAME   "1 ~ 1140회\n(2024.10.05 추첨까지)"
const char* last_game = "no.1140"; // range: no.1 ~ present
int result_won[] = { 7, 10, 22, 29, 31, 38, 15 };
...
float digits_mid_code[5][3] = {
    ...
    { 1, 1579, 1.3850877192982456f, },
    { 10, 1833, 1.6078947368421053f, },
    { 20, 1702, 1.4929824561403509f, },
    { 30, 1807, 1.5850877192982455f, },
    { 40, 1059, 0.9289473684210526f, },
};
...
float odd_even_code[45][9] = {
    ...
    { 12, 40.0f, 68.0f, 43.0f, 13.0f, 2.0f, 0.0f, 27.0f, 193.0f, },
    ...
    { 20, 5.0f, 34.0f, 63.0f, 36.0f, 17.0f, 4.0f, 26.0f, 185.0f, },
    ...
    { 7, 72.0f, 73.0f, 10.0f, 0.0f, 0.0f, 0.0f, 28.0f, 183.0f, },
    { 38, 0.0f, 0.0f, 3.0f, 25.0f, 65.0f, 62.0f, 28.0f, 183.0f, },
    { 6, 90.0f, 46.0f, 13.0f, 3.0f, 0.0f, 0.0f, 31.0f, 183.0f, },
    { 26, 3.0f, 14.0f, 41.0f, 56.0f, 32.0f, 6.0f, 31.0f, 183.0f, },
    ...
    { 35, 1.0f, 0.0f, 12.0f, 39.0f, 56.0f, 41.0f, 29.0f, 178.0f, },
